...
align = `
     <line x1="${X1}" y1="${Y1}" x2="${X1}" y2="${Y2}" stroke-dasharray="6" stroke="purple" />
     <line x1="${X1}" y1="${Y2}" x2="${X2}" y2="${Y2}" stroke-dasharray="6" stroke="purple" />
     <line x1="${X2}" y1="${Y1}" x2="${X1}" y2="${Y1}" stroke-dasharray="6" stroke="purple" />
`;      
